...
module.exports = {
  ...
  constant: function(line, convention, commitUrl) {
    ...
    if (pascal.test(line)) { convention.constant.pascal = convention.constant.pascal + 1; }
    if (allcaps.test(line)) { convention.constant.allcaps = convention.constant.allcaps + 1; }
    if (notallcaps.test(line)) { convention.constant.notallcaps = convention.constant.notallcaps + 1; }
    if (pascal.test(line) || allcaps.test(line) || notallcaps.test(line)) { convention.constant.commits.push(commitUrl); }
