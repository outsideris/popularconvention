...
module.exports = {
  ...
  imports: function(line, convention, commitUrl) {
    ...
    if (separated.test(line)) { convention.imports.separated = convention.imports.separated + 1; }
    if (noseparated.test(line)) { convention.imports.noseparated = convention.imports.noseparated + 1; }
    if (separated.test(line) || noseparated.test(line)) { convention.imports.commits.push(commitUrl); }
