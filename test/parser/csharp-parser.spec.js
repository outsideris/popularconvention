...
describe('C#-parser >', () => {
  ...
  describe('constant >', () => {
    it('check constant is pascal #1', () => {
      let convention = parser.constant('const string FooBar = "baz";');
      expect(convention.pascal).equal(1);
    });
  
    it('check constant is pascal #2', () => {
      let convention = parser.constant('const int Foo = "baz";');
      expect(convention.pascal).equal(1);
    });
  
    it('check constant is pascal #3', () => {
      let convention = parser.constant('public const int Foo = "baz";');
      expect(convention.pascal).equal(1);
    });
  
    it('check constant is pascal #4', () => {
      let convention = parser.constant('const string FOO_BAR = "baz";');
    ...
    it('check constant with all caps #2', () => {
      let convention = parser.constant('public const iint FOO_BAR = 1;');
      expect(convention.allcaps).equal(1);
    });
  
    it('check constant with all caps #3', () => {
      let convention = parser.constant('const iint X = 1;');
      expect(convention.allcaps).equal(1);
    });
    ...
    it('check constant with not all caps #3', () => {
      let convention = parser.constant('public const int fooBar = 1;');
      expect(convention.notallcaps).equal(1);
    });
  
    it('check constant with not all caps #4', () => {
      let convention = parser.constant('const int x=1;');
      expect(convention.notallcaps).equal(1);
    });
  });
