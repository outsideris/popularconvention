...
describe('Java-parser >', () => {
  ...
  describe('constant >', () => {
    it('check constant with all caps #1', () => {
      const convention = parser.constant(`  static public final String FOOBAR= "";`);
      expect(convention.allcaps).equal(1);
    });

    it('check constant with all caps #2', () => {
      const convention = parser.constant(`  public static final String FOOBAR2= "";`);
      expect(convention.allcaps).equal(1);
    });

    it('check constant with all caps #3', () => {
      const convention = parser.constant(`private final static String FOO_BAR = "";`);
      expect(convention.allcaps).equal(1);
    });

    it('check constant with all caps #4', () => {
      const convention = parser.constant(`final public static String FOO_BAR = "";`);
      expect(convention.allcaps).equal(1);
    });

    it('check constant with all caps #5', () => {
      const convention = parser.constant(`  public final String foobar = "";`);
    ...
    it('check constant with all caps #7', () => {
      const convention = parser.constant(`private final static String FOOBARa = "";`);
      expect(convention.allcaps).equal(0);
    });
    ...
    it('check constant with not all caps #3', () => {
      const convention = parser.constant(`public final static String FOOBARa = "";`);
      expect(convention.notallcaps).equal(1);
    });
    ...
    it('check constant with not all caps #5', () => {
      const convention = parser.constant(`  public static final String FOO_BAR= "";`);
      expect(convention.notallcaps).equal(0);
    });

    it('check constant with not all caps #6', () => {
      const convention = parser.constant(`  public final String Foo= "";`);
      expect(convention.notallcaps).equal(0);
    });
  });
  ...
  describe('staticvar >', () => {
    it('static variable with special prefix #1', () => {
      const convention = parser.staticvar(` static String _name;`);
      expect(convention.prefix).equal(1);
    });

    it('static variable with special prefix #2', () => {
      const convention = parser.staticvar(` static String $name;`);
      expect(convention.prefix).equal(1);
    });
  ...
  describe('finalstaticorder >', () => {
    it('public - static - final #1', () => {
      const convention = parser.finalstaticorder(`public static final String t1 = "";`);
      expect(convention.accstfin).equal(1);
    });

    it('public - static - final #2', () => {
      const convention = parser.finalstaticorder(`public static transient final String t2 = "";`);
      expect(convention.accstfin).equal(1);
    });

    it('public - static - final #3', () => {
      const convention = parser.finalstaticorder(`transient public static final String t3 = "";`);
      expect(convention.accstfin).equal(1);
    });

    it('public - static - final #4', () => {
      const convention = parser.finalstaticorder(`public final static String t4 = "";`);
      expect(convention.accstfin).equal(0);
    });

    it('public - final - static #1', () => {
      const convention = parser.finalstaticorder(`public final static String t1 = "";`);
      expect(convention.accfinst).equal(1);
    });

    it('public - final - static #2', () => {
      const convention = parser.finalstaticorder(`public final static transient String t2 = "";`);
      expect(convention.accfinst).equal(1);
    });

    it('public - final - static #3', () => {
      const convention = parser.finalstaticorder(`transient public final static String t3 = "";`);
      expect(convention.accfinst).equal(1);
    });

    it('public - final - static #4', () => {
      const convention = parser.finalstaticorder(`final public static String t4 = "";`);
      expect(convention.accfinst).equal(0);
    });

    it('final - public - static #1', () => {
      const convention = parser.finalstaticorder(`final public static String t1 = "";`);
      expect(convention.finaccst).equal(1);
    });

    it('final - public - static #2', () => {
      const convention = parser.finalstaticorder(`final public static transient String t2 = "";`);
      expect(convention.finaccst).equal(1);
    });

    it('final - public - static #3', () => {
      const convention = parser.finalstaticorder(`final transient public static String t3 = "";`);
      expect(convention.finaccst).equal(1);
    });

    it('final - public - static #4', () => {
      const convention = parser.finalstaticorder(`static public final String t4 = "";`);
      expect(convention.finaccst).equal(0);
    });

    it('static - public - final #1', () => {
      const convention = parser.finalstaticorder(`static public final String t1 = "";`);
      expect(convention.staccfin).equal(1);
    });

    it('static - public - final #2', () => {
      const convention = parser.finalstaticorder(`static public transient final String t2 = "";`);
      expect(convention.staccfin).equal(1);
    });

    it('static - public - final #3', () => {
      const convention = parser.finalstaticorder(`static transient public final String t3 = "";`);
      expect(convention.staccfin).equal(1);
    });

    it('static - public - final #4', () => {
      const convention = parser.finalstaticorder(`public static final String t4 = "";`);
